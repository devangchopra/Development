...
class demo:
    def showdata(self):
        ...
        for day in days:
            s = "select timetable.teachername,timetable.subjectcode,subjects.subjectname,timetable.dayofweek from timetable,subjects where subjects.subjectcode=timetable.subjectcode and timetable.slot='4PM-5PM' and subjects.degreename='" + self.cb1.get() + "' and subjects.semester=" + self.cb2.get() + " and dayofweek='" + day + "'"
    ...
    def __init__(self):
        ...
        self.t1=Treeview(self.p2,columns=("slot" ,"Monday","Tuesday","Wednesday","Thursday","Friday"))
